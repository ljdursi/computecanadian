...
\proposal{The federation partners, members, and funders must
come to agreement on clearly-delineated roles and responsibilities of
the central office and regional organizations.}
...
\proposal{Services should be piloted, with
definitions of success decided upon before the pilot. }
...
\proposal{The central office should be responsible for the
...
\proposal{Responsibility for implementation and operations
of researcher-facing services should generally belong to the
regional organizations or an external partner.}
...
\proposal{Each federation colleague must advocate on behalf
of the federation as a whole and the federation's researcher users to
their funding partners and other external partners.}
...
\addcontentsline{toc}{subsection}{Relationship with The Community}%

\proposal{A renewed federation should renew its
relationship with the researcher community, emphasizing transparency,
