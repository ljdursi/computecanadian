...
Commercial cloud providers are the competition & Commercial cloud
providers are one of many provision options \\ \hline \end{tabular}
} \end{table}
...
that the necessary coordination will happen to cross multiple
