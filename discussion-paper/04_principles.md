...
closely with other partners, so that researcher needs that require
cooperation between multiple service providers are met.
...
collaboration, not merely co-existance. A federation, which incorporates
